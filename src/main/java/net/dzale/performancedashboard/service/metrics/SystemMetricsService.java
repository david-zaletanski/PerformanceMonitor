package net.dzale.performancedashboard.service.metrics;

import net.dzale.performancedashboard.exceptions.PerformanceDashboardException;
import net.dzale.performancedashboard.repository.metrics.SystemMetricsRepository;
...
public class SystemMetricsService {
    ...
    public List<DataPoint2D> getRecentMetricsSystemCPULoadDataPoints() throws PerformanceDashboardException {
    ...
    public List<DataPoint4D> getRecentMetricsCPULoadDataPoints() throws PerformanceDashboardException {
    ...
    public List<MorrisDonutDataPoint> getRecentFSDataPoints() throws PerformanceDashboardException {
    ...
    public List<MorrisDonutDataPoint> getRecentMemoryDataPoints() throws PerformanceDashboardException {
        List<MorrisDonutDataPoint> dataPoints = new ArrayList<>();
        SystemMetrics metric = recentMetrics.peek();

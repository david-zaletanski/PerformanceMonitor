...
import net.dzale.performancedashboard.system.quartz.AutowiringSpringBeanJobFactory;
import org.quartz.*;
...
public class SystemMetricsCollectionConfig {
    ...
    @Bean
    public Scheduler scheduler(Trigger trigger, JobDetail job) throws PerformanceDashboardException {
        try {
            ...
            throw new PerformanceDashboardException("Unable to find quartz.properties file in classpath.", ex);
        } catch (SchedulerException ex) {
            throw new PerformanceDashboardException("Error creating scheduler.", ex);
        }
    }
